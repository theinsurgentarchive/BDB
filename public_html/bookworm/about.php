...
<body>
    ...
    <main class="about-page">
        <div class="about-page__inner">
            ...
            <section class="about-page__section about-page__intro">
                <h2>About BookWorm</h2>
                <p><strong>BookWorm</strong> is a simple, student-built book rating and discovery website.
            ...
            <section class="about-page__section about-page__rules">
            ...
            <section class="about-page__section about-page__credits">
                <h2>Credits</h2>
